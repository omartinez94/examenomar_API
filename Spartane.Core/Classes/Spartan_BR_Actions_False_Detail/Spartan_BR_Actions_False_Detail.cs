...
namespace Spartane.Core.Classes.Spartan_BR_Actions_False_Detail
{
    /// <summary>
    /// Spartan_BR_Actions_False_Detail table
    /// </summary>
    public class Spartan_BR_Actions_False_Detail: BaseEntity
    {
