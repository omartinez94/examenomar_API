...
namespace Spartane.Core.Classes.Spartan_User_Favorite_List
{
    /// <summary>
    /// Spartan_User_Favorite_List table
    /// </summary>
    public class Spartan_User_Favorite_List: BaseEntity
    {
        public int User_Favorite_List_Id { get; set; }
