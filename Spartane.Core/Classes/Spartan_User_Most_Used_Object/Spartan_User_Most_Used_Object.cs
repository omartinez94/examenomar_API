...
namespace Spartane.Core.Classes.Spartan_User_Most_Used_Object
{
    /// <summary>
    /// Spartan_User_Most_Used_Object table
    /// </summary>
    public class Spartan_User_Most_Used_Object: BaseEntity
    {
        public int User_Most_Used_Object_Id { get; set; }
