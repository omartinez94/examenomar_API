...
namespace Spartane.WebApi.Controllers
{
    ...
    public class Spartan_Session_LogController : BaseApiController
    {
        private ISpartan_Session_LogService service = null;

        //TODO: Global Data y Data Rerence tienen que estar en un controlador base
        public Spartan_Session_LogController(ISpartan_Session_LogService service)
        {
        ...
        public HttpResponseMessage Post(Spartan_Session_Log varSpartan_Session_Log)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    data = this.service.Insert(varSpartan_Session_Log); //, globalData, dataReference);
                }
