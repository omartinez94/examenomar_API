...
namespace Spartane.Services.Spartan_BR_Operator_Type
{
    ...
    /// </summary>
    public partial class Spartan_BR_Operator_TypeService : ISpartan_BR_Operator_TypeService
    {
        #region Fields
        private readonly IDataProvider _dataProvider;
        private readonly IDbContext _dbContext;
        private readonly IRepository<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> _Spartan_BR_Operator_TypeRepository;
        #endregion

        #region Ctor
        public Spartan_BR_Operator_TypeService(IDataProvider dataProvider, IDbContext dbContext, IRepository<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> Spartan_BR_Operator_TypeRepository)
        {
            this._dataProvider = dataProvider;
            this._dbContext = dbContext;
            this._Spartan_BR_Operator_TypeRepository = Spartan_BR_Operator_TypeRepository;
        ...
        public int SelCount()
        {
            return this._Spartan_BR_Operator_TypeRepository.Table.Count();
        }

        public IList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> SelAll(bool ConRelaciones)
        {
            return _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type>("sp_SelAllSpartan_BR_Operator_Type");
        }

        public IList<Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> SelAllComplete(bool ConRelaciones)
        {
            var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.Sp_SelallSpartan_BR_Operator_Type_Complete>("sp_SelAllComplete_Spartan_BR_Operator_Type");
            return data.Select(m => new Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type
            {
        ...
        public int ListaSelAllCount(string Where)
        {
            ...
            var rowCountData = _dbContext.ExecuteStoredProcedureList<Sp_ListSelCount_Spartan_BR_Operator_Type>("sp_ListSelCount_Spartan_BR_Operator_Type", padWhere);
            int rowCount = 0;
        ...
        public IList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> SelAll(bool ConRelaciones, string Where, string Order)
        {
            try
            {
                ...
                var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.SpListSelAllSpartan_BR_Operator_Type>("sp_ListSelAll_Spartan_BR_Operator_Type", padreWhere, padreOrderBy);

                return data.Select(m => new Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type
                {
                    OperatorTypeId = m.Spartan_BR_Operator_Type_OperatorTypeId,
                    Description = m.Spartan_BR_Operator_Type_Description,
                    Presentation_Control_Type = m.Spartan_BR_Operator_Type_Presentation_Control_Type,
                    Query_for_Fill_Condition = m.Spartan_BR_Operator_Type_Query_for_Fill_Condition,
                    Code_for_Fill_Condition = m.Spartan_BR_Operator_Type_Code_for_Fill_Condition,
                    Implementation_Code = m.Spartan_BR_Operator_Type_Implementation_Code,
        ...
        public IList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> SelAll(bool ConRelaciones, int CurrentRecordInt32, int RecordsDisplayedInt32)
        {
            return this._Spartan_BR_Operator_TypeRepository.Table.ToList();
        }

        public IList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> ListaSelAll(bool ConRelaciones, string Where, string Order)
        {
            return this._Spartan_BR_Operator_TypeRepository.Table.Where(Where).ToList();
        }

        public Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_TypePagingModel ListaSelAll(int startRowIndex, int maximumRows, string Where, string Order)
        {
            ...
            var data = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.SpListSelAllSpartan_BR_Operator_Type>("sp_ListSelAll_Spartan_BR_Operator_Type", padWhere, padOrder, padstartRowIndex, padmaximumRows);

            Spartan_BR_Operator_TypePagingModel result = null;

            if (data != null)
            {
                result = new Spartan_BR_Operator_TypePagingModel
                {
                    Spartan_BR_Operator_Types =
                        data.Select(m => new Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type
                {
                    OperatorTypeId = m.Spartan_BR_Operator_Type_OperatorTypeId
                    ,Description = m.Spartan_BR_Operator_Type_Description
                    ,Presentation_Control_Type = m.Spartan_BR_Operator_Type_Presentation_Control_Type
                    ,Presentation_Control_Type_Spartan_BR_Presentation_Control_Type = new Core.Classes.Spartan_BR_Presentation_Control_Type.Spartan_BR_Presentation_Control_Type() { PresentationControlTypeId = m.Spartan_BR_Operator_Type_Presentation_Control_Type.GetValueOrDefault(), Description = m.Spartan_BR_Operator_Type_Presentation_Control_Type_Description }
                    ,Query_for_Fill_Condition = m.Spartan_BR_Operator_Type_Query_for_Fill_Condition
                    ,Code_for_Fill_Condition = m.Spartan_BR_Operator_Type_Code_for_Fill_Condition
                    ,Implementation_Code = m.Spartan_BR_Operator_Type_Implementation_Code
        ...
        public IList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type> ListaSelAll(bool ConRelaciones, string Where)
        {
            return this._Spartan_BR_Operator_TypeRepository.Table.Where(Where).ToList();
        }

        public Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type GetByKey(int Key, bool ConRelaciones)
        {
            var padreKey = _dataProvider.GetParameter();
            padreKey.ParameterName = "OperatorTypeId";
            padreKey.DbType = DbType.Int32;
            padreKey.Value = Key;

            return _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.Spartan_BR_Operator_Type.Spartan_BR_Operator_Type>("sp_GetSpartan_BR_Operator_Type", padreKey).SingleOrDefault();
        }
        ...
        public bool Delete(int Key)
        {
            ...
            try
            {
                ...
                var padreResult = _dbContext.ExecuteStoredProcedureList<Spartane.Core.Classes.StoredProcedure.sp_DelSpartan_BR_Operator_Type>("sp_DelSpartan_BR_Operator_Type", padreKey).FirstOrDefault();
                if (padreResult != null)
